class NavBar extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="relative"><input class="p-1 bg-slate-300 rounded-full shadow-lg" type="text"
                placeholder="Cari..."> <span class="absolute cursor-pointer right-2 top-1  rounded-full"><svg
